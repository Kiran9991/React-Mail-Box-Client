...
const SingleItem = (props) => {
  ...
  const formattedDate = (dateString) => {
    ...
    const month = date.toLocaleString("en-US", { month: "short", hour: '2-digit', minute:'numeric' });
    return `${day} ${month}`;
  };
  ...
  return (
    <div className={inBox.mailUl} onClick={sendIsView}>
      ...
      <div className={inBox.mailRightSide}>
        <div>
          <button className={inBox.deleteBtn}>Delete</button>
        </div>
